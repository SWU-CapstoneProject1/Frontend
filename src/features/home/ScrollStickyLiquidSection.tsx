...
function ScrollStickyLiquidSection() {
  return (
    <section className="w-full bg-white py-28 transition-colors duration-300 dark:bg-slate-950">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {steps.map((step) => (
            <div
              key={step.number}
              className="group min-h-[250px] rounded-[30px] border border-stone-200 bg-white p-8 shadow-[0_16px_40px_rgba(15,23,42,0.05)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_22px_50px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-slate-900/80 dark:shadow-[0_20px_60px_rgba(0,0,0,0.35)] dark:hover:shadow-[0_24px_70px_rgba(0,0,0,0.45)]"
            >
              <div className="mb-10 flex items-center justify-between">
                ...
                <span className="text-5xl font-black tracking-tight text-stone-100 transition-colors group-hover:text-sky-100 dark:text-white/10 dark:group-hover:text-sky-400/20">
                  {step.number}
                </span>
              </div>

              <h3 className="text-xl font-black text-stone-900 dark:text-slate-50">
                {step.title}
              </h3>
