...
function CountUpItem({ label, targetValue }: { label: string; targetValue: number }) {
  ...
  return (
    <div
      ref={elementRef}
      className="flex flex-col items-center justify-center rounded-[30px] border border-stone-200 bg-white p-8 text-center shadow-[0_16px_40px_rgba(15,23,42,0.05)]"
    >
      <span className="mb-2 text-[10px] font-black uppercase tracking-widest text-sky-600">
        {label}
      </span>

      <h4 className="text-4xl font-black tracking-tight text-stone-900">
...
function RecentAnalysis() {
  return (
    <section className="w-full bg-[#F7F7F8] py-28">
